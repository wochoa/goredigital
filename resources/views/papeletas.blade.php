...
@section('titpage')
  Gobierno digital | Papeletas vehiculo
@endsection
@section('content')
...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Papeletas vehículos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="container-fluid">
    {{-- <div class="row justify-content-center"> --}}
      <div class="row pb-2">
        <div class="col-sm-6"><button class="btn btn-primary btn-sm">Nueva papeleta</button></div>
      </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-gray">
                <div class="card-header p-2">
                  <h3 class="card-title">Relacion de papeletas de vehiculos</h3>
                  <!-- /.card-tools -->
                </div>
                <!-- /.card-header -->
                <div class="card-body">
